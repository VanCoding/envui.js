        ...
        divider.on("mousedown",function(){
            ...
            function mousemove(e){
                if(e.which){
                    ...
                    if(group.getMinHeight() > newheight){
                        newheight = group.getMinHeight();
                    }
